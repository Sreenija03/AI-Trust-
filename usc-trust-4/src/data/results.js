...
export const RESULTS = [
  ...
  },
  {
    ...
    testsTotal: 93,
    measured: true,
    // This run used gpt-4.1-nano as its own judge (same-family). The flag below
    // keeps that conflict visible on the leaderboard, exactly as when it was run live.
    judge: "gpt-4.1-nano",
    judgeFamily: "OpenAI",
    selfFamilyJudged: true,
    selfFamilyCount: 93,
    pillars: {
      veracity: { score: 79.8, passed: 12, total: 14 },
      care: { score: 84.2, passed: 10, total: 11 },
      candor: { score: 88.0, passed: 13, total: 14 },
      cultural: { score: 96.0, passed: 11, total: 11 },
      manipulation: { score: 71.3, passed: 8, total: 11 },
      reliability: { score: 86.0, passed: 9, total: 10 },
      transparency: { score: 81.1, passed: 9, total: 11 },
      clarity: { score: 87.2, passed: 10, total: 11 },
    },
  },
];
