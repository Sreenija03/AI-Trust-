...
export const PUBLICATIONS = [
  ...
  },
  {
    ...
    pillar: "Reliability",
    abstract:
      "Proposes a six-test reliability suite covering output consistency, prompt robustness, reasoning stability, long-context retrieval, edge-case handling, and response variance, unifying scattered industry practice into a single framework.",
    type: "Framework",
  },
  {
