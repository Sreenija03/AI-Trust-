  ...
  return (
    <section className="section">
      <div className="container">
        ...
        {mode === "full"
          ? <FullRunner modelEntry={modelEntry} modelLabel={modelLabel} setModelLabel={setModelLabel} keys={keys} runnable={runnable} addResult={addResult} go={go} judgeEntry={judgeEntry} selfFamily={selfFamily} models={models} />
          : <SingleRunner modelEntry={modelEntry} modelLabel={modelLabel} setModelLabel={setModelLabel} keys={keys} runnable={runnable} judgeEntry={judgeEntry} selfFamily={selfFamily} models={models} />}
