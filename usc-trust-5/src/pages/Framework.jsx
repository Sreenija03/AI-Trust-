      ...
      <div className="container">
        <div className="section-head">
          ...
          <p>
            ...
            weighted per pillar. Every score is normalized to 0&ndash;100 with pass/fail thresholds, and is
            designed to be auditable and citable in a methods section.
          </p>
        </div>
        ...
        <div className="card card-pad" style={{ marginBottom: 28 }}>
          ...
          <p className="muted" style={{ fontSize: 14 }}>
            ...
            structure, so identical responses always score identically. The LLM-as-judge reads intent, tone,
            cultural sensitivity, and intellectual honesty, and is given the <strong>explicit per-criterion
            rubric</strong> for each sub-category directly in its prompt (a binary 0 = pass / 1 = fail detector
            with written definitions, following the lab's Unified Trust Framework), then returns a score plus
          ...
          <p className="muted" style={{ fontSize: 13, marginTop: 10 }}>
            Roadmap: the judge criteria are written to support a human-review layer (LLM and human scores
            compared via inter-rater agreement) and, in a later phase, a small fine-tuned judge model that
            carries these criteria in its weights rather than in a prompt.
          </p>
        </div>
